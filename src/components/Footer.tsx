					...
					<div className='max-w-8xl mx-auto px-5 py-6'>
						...
						<div>
							<h2 className='my-4 text-sm'>
								Lorem ipsum accumsan arcu, consectetur adipiscing elit. Dolor proin tempor sed fermentum sit <br className='hidden lg:inline-block' /> pretium pellentesque. Dictumst risus elementum
								dignissim risus, lobortis molestie.
							</h2>
						</div>

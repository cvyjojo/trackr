		...
		<aside className='fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60'>
			<div className='flex flex-col justify-between h-full'>
						...
						<ul className='space-y-1'>
							<li className='flex item-center justify-around'>
								<Link
									href='/'
									onClick={handleClick}
									className={`flex items-center  rounded-xl  hover:bg-violet-100 hover:text-black font-bold text-sm  p-3 w-40 ${
										activeTab === 'Home' ? 'bg-violet-100 text-black' : 'bg-white text-black'
									}`}>
							...
							<li className='flex item-center justify-around'>
								<Link
									...
									onClick={handleClick}
									className={`flex items-center  rounded-xl  hover:bg-violet-100 hover:text-black  font-bold text-sm  p-3 w-40 ${
										activeTab === 'Market' ? 'bg-violet-100 text-black' : 'bg-white text-black'
									}`}>
									<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' className='text-lg mr-16' viewBox='0 0 24 24'>
										<path fill='none' d='M0 0h24v24H0z' />
							...
							<li className='flex item-center justify-around'>
								<Link
									...
									onClick={handleClick}
									className={`flex items-center  rounded-xl  hover:bg-violet-100 hover:text-black  font-bold text-sm  p-3 w-40 ${
										activeTab === 'Analysis' ? 'bg-violet-100 text-black' : 'bg-white text-black'
									}`}>
									<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' className='text-lg mr-16' viewBox='0 0 24 24'>
										<path fill='none' d='M0 0H24V24H0z' />
							...
							<li className='flex item-center justify-around'>
								<Link
									...
									onClick={handleClick}
									className={`flex items-center  rounded-xl  hover:bg-violet-100 hover:text-black  font-bold text-sm  p-3 w-40 ${
										activeTab === 'Goals' ? 'bg-violet-100 text-black' : 'bg-white text-black'
									}`}>
							...
							<li className='flex item-center justify-around'>
								<Link
									...
									onClick={handleClick}
									className={`flex items-center  rounded-xl hover:bg-violet-100 hover:text-black font-bold text-sm  p-3 w-40 ${
										activeTab === 'Settings' ? 'bg-violet-100 text-black' : 'bg-white text-black'
									}`}>
				...
				<div className='mx-auto p-4'>
					<button
						type='button'
						className='inline-flex items-center justify-center h-9 px-9 rounded-xl outline outline-violet-600 hover:bg-violet-100 text-black text-sm font-semibold transition'>

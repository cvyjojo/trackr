				...
				<div className='max-w-4xl mx-auto'>
					<div className='flex items-center justify-between'>
						<div>
							<button
								type='button'
								className='flex items-center focus:outline-none rounded-lg text-gray-600 hover:text-violet-600 focus:text-violet-600 font-semibold p-2 border border-transparent hover:border-violet-300 focus:border-violet-300 transition'
							>
								...
								<div className='flex items-stretch'>
									...
									<div className='flex flex-nowrap -space-x-3'>
										<div className='h-9 w-9'>
											<Image className='object-cover w-full h-full rounded-full' src='/images/stock/photo-1534528741775-53994a69daeb.jpg' width={100} height={10} alt='aaaa' />
										</div>
										<div className='h-9 w-9'>
											<Image className='object-cover w-full h-full rounded-full' src='/images/stock/photo-1534528741775-53994a69daeb.jpg' width={100} height={10} alt='avatar' />
										</div>
									</div>
								</div>
								...
								<div>
									...
									<div className='space-y-4'>
										<div className='p-4 bg-white border rounded-xl text-gray-800 space-y-2'>
											...
											<a href='/' className='font-bold hover:text-violet-800 hover:underline'>

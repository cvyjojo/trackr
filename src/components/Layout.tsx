...
export default function Main() {
	return (
		<div className='relative grotesk max-w-8xl mx-auto bg-yellow-50 overflow-hidden max-h-screen'>
				...
				<div className='flex flex-col justify-between h-full'>
					<div className='flex-grow'>
						<div className='px-4 py-6 text-center border-b'>
								<a href='/' className='align-middle text-xl leading-none font-bold text-black'>
									<span>Track</span>
